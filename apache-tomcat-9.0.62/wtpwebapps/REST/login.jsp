        ...
        <div class="LoginBanner">
           <img style="width: 100px; height: 100px; margin-left: 100px; margin-top: 25px;" src="https://freesvg.org/img/applications-internet.png">
            ...
            <form action="./login" method="post">
                ...
                <button type="submit" style="display: flex; align-items: center;"><p style="margin-left: 130px;"> LOGIN </p></button>
            	<br>
            	<table>
					<tr>
						<td><a href="http://localhost:8080/REST/api/user/home">Return to home</a></td>
						<td><a href="http://localhost:8080/REST/api/luggage/search" style="margin-left: 130px;">Return to register</a>
					</tr>
				</table>
            </form>
