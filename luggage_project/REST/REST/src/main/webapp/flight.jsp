...
<body>
    <div class="FlightPage" style="display: block;">
        <h1 style="text-align: center;  margin-top: 50px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-size: 3vwh;">Search Flights </h1>
            ...
            <form action="./search" method="post">
                <div class="icon" style="margin-top: 50px;">
                    ...
                    <div class="user_entry">
                        <input name="flightNum" type="text" placeholder="Enter a flight number" required/>
                    </div>
                </div>
                <button type="submit" style="display: flex; align-items: center;"><p style="margin-left: 100px;"> SEARCH </p></button>
            	<br>
